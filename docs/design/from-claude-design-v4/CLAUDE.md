...
Design source of truth: `DESIGN_HANDOFF.md`; motion and card personality: `MOTION_HANDOFF.md`; features: `TAGS_HANDOFF.md`, `QUICKADD_HANDOFF.md`, `NOTIFICATIONS_HANDOFF.md`. Visual reference: `mockups/betbook-mockups.html` and `mockups/betbook-card-motion.html`.
